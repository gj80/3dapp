<?php require APPROOT.'/app/views/inc/header2.php'; ?>
              ...
              <x3d class="w-100" id="wire">
                <scene>
                    <Switch whichChoice=<?=$data['type']?> id='SceneSwitch'>
                        <transform>
                            <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="<?php echo "../../public/x3ds/cocacola.x3d"?>" > </inline>
                        </transform>
                        <transform>
                            <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="<?php echo "../../public/x3ds/coke.x3d"?>" > </inline>
                        </transform>
                        <transform>
                            <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="<?php echo "../../public/x3ds/pepsi.x3d"?>" > </inline>
                        </transform>
                        <transform>
                            <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="<?php echo "../../public/x3ds/newfanta.x3d"?>" > </inline>
                        </transform>
                        <transform>
                            <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="<?php echo "../../public/x3ds/soda.x3d"?>"> </inline>
                        </transform>
                    </Switch>
                </scene>
              </x3d>
...
<?php require APPROOT . '/app/views/inc/footer2.php'; ?>