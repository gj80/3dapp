      ...
      <div class="row">
        <div class="col-md-4 pb-4">
          <div class="card rounded-2 p-2">
            <img src="public/images/3.png" alt="" height="240px" style="border-top-right-radius: 0.3rem; border-top-left-radius: 0.3rem;"/>
            <div class="card-body">
            ...
            <div class="card-footer d-flex border-0 bg-transparent pt-0">
              <a href="<?php echo URLROOT."/model/cocacola"; ?>" class="btn btn-outline-primary py-2 px-4 ms-auto">View Model</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-4">
          <div class="card rounded-2 p-2">
            <img src="public/images/1.png" alt="" height="240px" style="border-top-right-radius: 0.3rem; border-top-left-radius: 0.3rem;"/>
            <div class="card-body">
            ...
            <div class="card-footer d-flex border-0 bg-transparent pt-0">
              <a href="<?php echo URLROOT."/model/fanta"; ?>" class="btn btn-outline-primary py-2 px-4 ms-auto">View Model</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-4">
          <div class="card rounded-2 p-2">
            <img src="public/images/2.png" alt="" height="240px" style="border-top-right-radius: 0.3rem; border-top-left-radius: 0.3rem;"/>
            <div class="card-body">
            ...
            <div class="card-footer d-flex border-0 bg-transparent pt-0">
              <a href="<?php echo URLROOT."/model/pepsi"; ?>" class="btn btn-outline-primary py-2 px-4 ms-auto">View Model</a>
            </div>
          </div>
        </div>
      </div>
